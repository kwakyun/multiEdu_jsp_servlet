...
public class BoardDAOimpl implements BoardDAO {
    ...
    public BoardDAOimpl() { //계속 사용하려면 static을 사용한다.
    ...
    public int insert(BoardVO vo) {
        ...
        try {
            ...
            String sql = "insert into board(title,content,writer,wdate) " +
                    "values(?,?,?,?)";
    ...
    public List<BoardVO> searchList(String searchKey, String searchWord) {
        ...
        if(searchKey.equals("title")){
            sql = "select * from board where title like ? order by num asc";
        }else if(searchKey.equals("content")){
            sql = "select * from board where content like ? order by num asc";
        }
    ...
    public List<BoardVO> selectPage(int page, int limit) {
        ...
        try {
            conn = DriverManager.getConnection(url, user_name, password);
            String sql = "select * from board where num order by num limit ?,?";
            pstmt = conn.prepareStatement(sql);
